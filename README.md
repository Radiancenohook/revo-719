...
```bash
git clone https://github.com/Radiancenohook/revo-719.git
cd revo-719
python setup.py
```
...
| [github](https://github.com/Radiancenohook/revo-719)
...
```bash
git clone https://github.com/Radiancenohook/revo-719 && cd revo
...
<!-- Last updated: 2026-06-06 16:52:04 -->
